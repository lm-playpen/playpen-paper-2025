...
if __name__ == "__main__":
    ...
    parser.add_argument('--cache_dir', default = '', help='cache directory to store models')
    ...
    parser.add_argument('--use_unsloth', default=True, choices=[True, False], help='huggingface repository to save the trained model')
